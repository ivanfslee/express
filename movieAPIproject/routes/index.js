...
//We added apiKey validation at the app.js, application level,
  //So requiring in the apiKey file is not needed anymore
...
router.get('/most_popular', (req, res, next) => {
  ...
  //We added api_key validation on the application level, 
    //in app.js, through a piece of middleware
    //So the following three lines of code are not necessary anymore:
